<div align="center">
  ...
  <p>
    <a href="https://github.com/dh6k/YTSpoofingStream_v3/releases"><img src="https://img.shields.io/badge/release-v0.2.6-blue.svg?style=flat-square" alt="Latest Release"></a>
...
> This fork (**vorapis edition**, current: **v0.2.6**) adapts the YTSS engine to coexist with Project VORAPIS v3 and ships its own CRX packaging / auto-update feed. Upstream v0.2.0 features (Audio-Only, dynamic i18n, stats) are integrated.
...
CI: push tag `v0.2.6` (or run **Package CRX** workflow). Store `key.pem` as repo secret `CRX_PEM_BASE64` so later builds keep the same extension ID.
