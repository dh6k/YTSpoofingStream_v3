<div align="center">
  ...
  <p>
    <a href="https://github.com/dh6k/YTSpoofingStream_v3/releases"><img src="https://img.shields.io/badge/release-v0.2.6-blue.svg?style=flat-square" alt="Phiên bản Mới nhất"></a>
...
> Fork này (**vorapis edition**, hiện tại: **v0.2.6**) điều chỉnh engine YTSS để chạy song song với Project VORAPIS v3, kèm đóng gói CRX và feed tự cập nhật riêng. Đã tích hợp các tính năng upstream v0.2.0 (Audio-Only, i18n động, stats).
...
CI: push tag `v0.2.6` (hoặc chạy workflow **Package CRX**). Lưu `key.pem` dưới secret `CRX_PEM_BASE64` để các bản sau giữ nguyên extension ID.
